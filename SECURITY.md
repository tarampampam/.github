...
1. **Preferred**: Send a detailed report via email to [github@tarampamp.am](mailto:github@tarampamp.am)
2. **Alternatively**: Use GitHub’s [private security advisory form][advisory-form] for the affected repository

[advisory-form]: https://docs.github.com/en/code-security/security-advisories/guidance-on-reporting-and-writing/privately-reporting-a-security-vulnerability
...
This policy covers:
- All public and private repositories under the [@tarampampam](https://github.com/tarampampam) GitHub account
